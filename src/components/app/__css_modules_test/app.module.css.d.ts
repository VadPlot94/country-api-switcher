declare const styles: {
  ...
  readonly 'app__container-content': string;
  readonly 'app__container-header': string;
  ...
  readonly 'filter-dropdown__item': string;
  readonly header: string;
  readonly 'loader-dots': string;
  readonly 'notification-banner': string;
};
export = styles;
